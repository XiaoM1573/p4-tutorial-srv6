...
def decodeIPv6(encoded_ipv6_addr):
    return socket.inet_ntop(socket.AF_INET6, encoded_ipv6_addr)
...
if __name__ == '__main__':
    ...
    assert(enc_ipv6 == b'\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01')
